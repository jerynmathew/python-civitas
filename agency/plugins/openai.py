...
Install:
    pip install python-agency[openai]

Usage:
    from agency.plugins.openai import OpenAIProvider
...
class OpenAIProvider:
    ...
    Requires ``pip install python-agency[openai]``.
    ...
    def __init__(
        ...
        if not _HAS_OPENAI:
            raise ImportError(
                ...
                "Install it with: pip install python-agency[openai]"
            )
