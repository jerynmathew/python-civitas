...
from civitas.dashboard.collector import MetricsCollector, RuntimeSnapshot
...
def render_supervision_tree(
    ...
    """
    tree = Tree("[bold cyan]Civitas Runtime[/bold cyan]")
...
def render_dashboard(collector: MetricsCollector) -> Layout:
    ...
    header_text = (
        f"[bold cyan]Civitas Dashboard[/bold cyan]  "
        f"[dim]Uptime: {uptime}  "
